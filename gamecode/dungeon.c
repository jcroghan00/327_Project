...
void move_pc(dungeon_t *d)
{
    ...
    while(!hasMoved)
    {
        ...
        if (d->monster_map[d->pc.pos[dim_y]][d->pc.pos[dim_x]] != NULL)
        {
            d->monster_map[d->pc.pos[dim_y]][d->pc.pos[dim_x]]->living = 0;
            d->monster_map[d->pc.pos[dim_y]][d->pc.pos[dim_x]] = NULL;
        }
